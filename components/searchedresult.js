    ...
    useEffect(()=>{
        ...
        jobCards.forEach((jobCard) => {
            jobCard.addEventListener("click", () => {
                ...
                const title = jobCard.querySelector(`.${styles.jobcardtitle}`);
        ...
        <div className={styles.searchedjobs}>
            ...
            <div className={styles.jobcards}>
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>UI / UX Designer</div>
                    ...
                    <div className={styles.jobdetailbuttons}>
                        <button className={`${styles.searchbuttons} ${styles.detailbutton}`}>Full Time</button>
                        <button className={`${styles.searchbuttons} ${styles.detailbutton}`}>Min. 1 Year</button>
                        <button className={`${styles.searchbuttons} ${styles.detailbutton}`}>Senior Level</button>
                    </div>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>Sr. Product Designer</div>
                    <div className={styles.jobcardsubtitle}>
                        The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>User Experience Designer</div>
                    <div className={styles.jobcardsubtitle}>
                            The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>Product Designer</div>
                    <div className={styles.jobcardsubtitle}>
                        The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>UI Developer</div>
                    <div className={styles.jobcardsubtitle}>
                        The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>User Interface Designer</div>
                    <div className={styles.jobcardsubtitle}>
                        The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
                ...
                <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>UX Designer</div>
                    <div className={styles.jobcardsubtitle}>
                        The User Experience Designer position exists to create compelling and digital user experience through excellent design...
                    </div>
                    <div className={styles.jobdetailbuttons}>
            ...
            <div className={styles.joboverview}>
                <div className={styles.joboverviewcards}>
                    ...
                    <div className={styles.joboverviewcard}>
                        <div className={`${styles.jobcard} ${styles.overviewcard}`}>
                            ...
                            <div className={styles.joboverviewbuttons}>
                                <div className={`${styles.searchbuttons} ${styles.timebutton}`}>Full Time</div>
                                <div className={`${styles.searchbuttons} ${styles.levelbutton}`}>Senior Level</div>
                                <div className={styles.jobstat}>New</div>
                                <div className={styles.jobday}>4d</div>
                            </div>
                        </div>
                    </div>
                ...
                <div className={styles.jobexplain}>
                    <img className={styles.jobbg} alt="" />
                    ...
                    <div className={styles.jobexplaincontent}>
                        ...
                        <div className={styles.jobsubtitlewrapper}>
                            <div className={styles.companyname}>Patreon <span className={styles.complocation}>Londontowne, MD.</span></div>
                            <div className={styles.posted}>Posted 8 days ago<span className={styles.appnumber}>98 Application</span></div>
                        </div>
                        <div className={styles.explainbar}>
                            <div className={styles.explaincontents}>
                                <div className={styles.explaintitle}>Experience</div>
                                <div className={styles.explainsubtitle}>Minimum 1 Year</div>
                            </div>
                            <div className={styles.explaincontents}>
                                <div className={styles.explaintitle}>Work Level</div>
                                <div className={styles.explainsubtitle}>Senior level</div>
                            </div>
                            <div className={styles.explaincontents}>
                                <div className={styles.explaintitle}>Employee Type</div>
                                <div className={styles.explainsubtitle}>Full Time Jobs</div>
                            </div>
                            <div className={styles.explaincontents}>
                                <div className={styles.explaintitle}>Offer Salary</div>
                                <div className={styles.explainsubtitle}>$2150.0 / Month</div>
                            </div>
                        </div>
                        ...
                        <div className={styles.overviewtext}>
                            ...
                            <div className={styles.overviewtextitem}>3+ years working as a product designer.</div>
                            <div className={styles.overviewtextitem}>A portfolio that highlights your approach to problem solving, as well as you skills in UI.</div>
                            <div className={styles.overviewtextitem}>Experience conducting research and building out smooth flows.</div>
                            <div className={styles.overviewtextitem}>Excellent communication skills with a well-defined design process.</div>
                            <div className={styles.overviewtextitem}>Familiarity with design tools like Sketch and Figma</div>
                            <div className={styles.overviewtextitem}>Up-level our overall design and bring consistency to end-user facing properties</div>
                        </div>
                    </div>
                </div>
