...
export default function Searchedresult() {
    ...
    async function handleJobClick(job) {
        ...
        // const res = await fetch(`http://localhost:3000/job?jobid=${job.jobid}`);
        // const json = await res.json();
        // await setJobDesc(json.data);
        // await setSelectedJob(job);
        ...
        <div className={styles.searchedjobs}>
            ...
            <div className={styles.jobcards}>
                ...
                {/* <div className={styles.jobcard}>
                    ...
                    <div className={styles.jobcardtitle}>{jobs?jobs[0].jobtitle:'xxxxxxxx'}</div>
                    <div className={styles.jobcardsubtitle}>
